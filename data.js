...
const TITLES = [
  ...
  { id:'t_inn_shu', name:'鼠来宝·挚友', desc:'鼠来宝好感度达到 300', tier:'inn',
    check:()=>{ const a=SM.getJSON(INN_AFFINITY_KEY,{}); return (a.shu||0)>=INN_MAX_AFFINITY; },
    progress:()=>{ const a=SM.getJSON(INN_AFFINITY_KEY,{}); return Math.min((a.shu||0)/INN_MAX_AFFINITY,1); } },
  { id:'t_inn_niu', name:'牛气冲天·挚友', desc:'牛气冲天好感度达到 300', tier:'inn',
    check:()=>{ const a=SM.getJSON(INN_AFFINITY_KEY,{}); return (a.niu||0)>=INN_MAX_AFFINITY; },
    progress:()=>{ const a=SM.getJSON(INN_AFFINITY_KEY,{}); return Math.min((a.niu||0)/INN_MAX_AFFINITY,1); } },
  { id:'t_inn_hu', name:'虎虎生威·挚友', desc:'虎虎生威好感度达到 300', tier:'inn',
    check:()=>{ const a=SM.getJSON(INN_AFFINITY_KEY,{}); return (a.hu||0)>=INN_MAX_AFFINITY; },
    progress:()=>{ const a=SM.getJSON(INN_AFFINITY_KEY,{}); return Math.min((a.hu||0)/INN_MAX_AFFINITY,1); } }
];
