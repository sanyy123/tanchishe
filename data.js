...
{ id: 'tips', icon: '💡', title: '小技巧', content: '<h4>💡 高手小技巧</h4><ul><li><span class="hl2">善用护盾</span>：留一个护盾在身上，被猫追上或撞石头时可以救命。</li><li><span class="hl2">连击冲分</span>：看到食物密集的区域，一口气冲过去连吃 5 个以上，倍率立刻上来。</li><li><span class="hl2">围猫战术</span>：利用蛇身长的优势，绕一个大圈把猫围住，能拿 50 分。</li><li><span class="hl2">龙炎爆清路</span>：装备龙皮肤时，前方石头挡路可以用炎爆清掉；猫追得紧时也能用炎爆击退猫。</li><li><span class="hl2">虎分身骗猫</span>：装备虎皮肤时，被猫追得走投无路就按 E 放分身，猫会去追分身，趁机脱身。</li><li><span class="hl2">传送门逃生</span>：被猫或石头逼到角落时，钻进传送门，瞬间转移到地图另一头。</li><li><span class="hl2">皮肤技能</span>：牛可以撞碎石头、马可以复活、兔可以连击、蛇可以穿墙、虎可以分身、龙可以炎爆、羊可以眩晕猫。</li><li><span class="hl3">手机作弊</span>：2 秒内连点标题“🐍 十二生肖闯江湖”5 次，解锁全部皮肤 + 成就！</li></ul>' }
];
